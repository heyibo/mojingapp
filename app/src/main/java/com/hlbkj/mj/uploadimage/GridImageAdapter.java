package com.hlbkj.mj.uploadimage;
...
//        LinearLayout ll_del;
        ...
        public ViewHolder(View view) {
            super(view);
            mImg = (CircleImageView) view.findViewById(R.id.fiv);
//            ll_del = (LinearLayout) view.findViewById(R.id.ll_del);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.mipmap.pic_head_mine);
...
//
//                        //通知activity更改TextView值
//                        MessageEvent messageEvent = new MessageEvent(list.size()+"/4");
